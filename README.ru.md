...
отметки времени запечатаны внутри; сам контейнер не выдаёт ничего, кроме собственного размера.
...
Четыре вещи сказаны прямо, потому что функция безопасности, которая себя переоценивает, хуже, чем никакой:
