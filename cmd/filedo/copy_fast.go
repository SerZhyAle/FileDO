...
// first small-file batch (the same class of fault CopyProgress had).
type FastCopyProgress struct {
	...
	// Stuck file detection (LastProgressFiles is with the int64s above)
	...
	// Current file progress tracking (CurrentFileBytes/Size are with the int64s above)
