...
func NewProgressTracker(totalItems, totalBytes int64, interval time.Duration) *ProgressTracker {
...
func formatETA(d time.Duration) string {
	...
	return fmt.Sprintf("%.0fh%.0fm", d.Hours(), float64(d%time.Hour)/float64(time.Minute))
}